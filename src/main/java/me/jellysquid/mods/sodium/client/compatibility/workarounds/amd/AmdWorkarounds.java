...
public class AmdWorkarounds {
    ...
    private static void logWarning() {
        ...
        LOGGER.error("READ ME!   https://github.com/ANError1/Iron/issues");
        // This link should not point to the issue page for Sodium
        // LOGGER.error("READ ME!   https://github.com/CaffeineMC/sodium/issues");
        LOGGER.error("READ ME!");
    }
}
// by embeddium pr #549 https://github.com/FiniteReality/embeddium/pull/549
